...
```json
{
    ...
    "0x00000000000000000000000000000000013241a5": ["0x33434ebd8799bc93f3623c7eb619350e41fb08d1", ["0xb3b5da596b4ba5caa603afd98c08c294a68ff34d"]],
...
- `check_permission`: 表示发送交易时，是否检查账户拥有相应的权限，其中true表示打开检查，false表示关闭检查，默认为false。
- `check_quota`: 表示发送交易时，是否检查块的gas和Account的gas是否超过上限，其中true表示打开检查，false表示关闭检查，默认为false。
