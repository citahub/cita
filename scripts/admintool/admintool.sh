...
display_help()
{
    ...
    echo
    echo "-A authorities of current network"
    echo "   default generated by create_key_addr"
    echo
    exit 0
}
...
create_genesis(){
    ...
    python ${BINARY_DIR}/scripts/admintool/create_genesis.py \
           --chain_id ${CHAIN_ID} \
           --timestamp ${TIMESTAMP} \
           --authorities ${CURRENT_AUTHORITIES} \
           --init_data "${CONFIG_DIR}/init_data.json" \
