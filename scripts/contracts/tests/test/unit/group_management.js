...
const name = appchain.utils.utf8ToHex('testGroup');
const newName = appchain.utils.utf8ToHex('testGroupNewName');
const newName2 = appchain.utils.utf8ToHex('testGroupNewName2');
