...
const newName = citaSDK.utils.utf8ToHex('testPermissionNewName');
const nameA = citaSDK.utils.utf8ToHex('testPermissionA');
const nameB = citaSDK.utils.utf8ToHex('testPermissionB');
