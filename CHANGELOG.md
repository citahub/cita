...
v0.23.0 upgraded the P2P discovery protocol, which is incompatible with the running V0.22.0 CITA node. So the CITA nodes between v0.23.0 and v0.22.0 cannot discover each other. Therefore, when upgrading, all nodes in the network need to be upgraded to v0.23.0 at the same time.

Following [Upgrade Instructions](https://docs.citahub.com/en-US/cita/protocol-upgrade/overview) to upgrade the nodes.

### New Feature Description

The 0.23.0 version added two RPC interface:
