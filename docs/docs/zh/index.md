...
如果你是第一次使用 CITA 的用户，我们建议你从[快速入门](https://cryptape.github.io/cita/zh/system_management/permission/index.html)开始，在这一章节中我们将带你熟悉如果快速的搭建起一条简单的链并运行其中的节点。
这以后，你可以继续探索关于 CITA 的更多内容。

> 如果你有文档没有解答到的问题，或者操作结果与文档内容不符，请查看帮助页面