...
mod tests {
    ...
    fn complete_test() {
        assert_eq!(
            ...
            H256::from_str("9bd41e0d43f4ec7a703edc2eb9fbb4106e1bc2a845e9ee1d4f3f4cf99b8549e6")
                .unwrap()
        );
    ...
    fn complete_test_raw() {
        assert_eq!(
            ...
            H256::from_str("e30a149e738cfaf89fb3a2267d7109a1bda978320426c2ff8b3a2d77aa103a6a")
                .unwrap()
        );
    }
