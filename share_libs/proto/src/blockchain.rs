...
impl ::protobuf::Message for Transaction {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.gas.is_empty() {
            my_size += ::protobuf::rt::string_size(4, &self.gas);
        }
    ...
    fn descriptor_static(_: ::std::option::Option<Transaction>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                    "gas",
                    Transaction::get_gas_for_reflect,
                    Transaction::mut_gas_for_reflect,
                ));
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBytes>(
                    "data",
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x06height\x18\x02\x20\x01(\x04R\x06height\"\x85\x01\n\x0bTransaction\
    \x12\x0e\n\x02to\x18\x01\x20\x01(\tR\x02to\x12\x14\n\x05nonce\x18\x02\
    \x20\x01(\tR\x05nonce\x12*\n\x11valid_until_block\x18\x03\x20\x01(\x04R\
    \x0fvalidUntilBlock\x12\x10\n\x03gas\x18\x04\x20\x01(\tR\x03gas\x12\x12\
    ...
    \x04hash\x12\x16\n\x06result\x18\x02\x20\x01(\x0cR\x06result\"C\n\tBlock\
    Body\x126\n\x0ctransactions\x18\x01\x20\x03(\x0b2\x12.SignedTransactionR\
    \x0ctransactions\"g\n\x05Block\x12\x18\n\x07version\x18\x01\x20\x01(\rR\
    \x07version\x12$\n\x06header\x18\x02\x20\x01(\x0b2\x0c.BlockHeaderR\x06h\
    ...
    \r\n\x05\x04\x03\x02\x04\x04\x12\x04'\x04&\x14\n\x0c\n\x05\x04\x03\x02\
    ...
    \x02\x01\x12\x032\x04\x16\"\x18\x20SignedTransaction\x20hash\n\n\r\n\x05\
    \x04\x05\x02\x01\x04\x12\x042\x0413\n\x0c\n\x05\x04\x05\x02\x01\x05\x12\
    \x032\x04\t\n\x0c\n\x05\x04\x05\x02\x01\x01\x12\x032\n\x11\n\x0c\n\x05\
    \x04\x05\x02\x01\x03\x12\x032\x14\x15\n\x18\n\x04\x04\x05\x02\x02\x12\
    \x033\x04\x15\"\x0bpublic\x20key\n\n\r\n\x05\x04\x05\x02\x02\x04\x12\x04\
    3\x042\x16\n\x0c\n\x05\x04\x05\x02\x02\x05\x12\x033\x04\t\n\x0c\n\x05\
    \x04\x05\x02\x02\x01\x12\x033\n\x10\n\x0c\n\x05\x04\x05\x02\x02\x03\x12\
    \x033\x13\x14\n!\n\x02\x04\x06\x12\x048\0;\x012\x15\x20data\x20precompil\
    e\x20API\n\n\n\n\x03\x04\x06\x01\x12\x038\x08\x12\n\x0b\n\x04\x04\x06\
    \x02\0\x12\x039\x04\x13\n\r\n\x05\x04\x06\x02\0\x04\x12\x049\x048\x14\n\
