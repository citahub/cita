...
pub struct RichStatus {
    ...
    pub account_gas_limit: ::protobuf::SingularPtrField<AccountGasLimit>,
...
impl RichStatus {
    ...
    // Param is passed by value, moved
    pub fn set_account_gas_limit(&mut self, v: AccountGasLimit) {
        self.account_gas_limit = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_account_gas_limit(&mut self) -> &mut AccountGasLimit {
    ...
    // Take field
    pub fn take_account_gas_limit(&mut self) -> AccountGasLimit {
        self.account_gas_limit.take().unwrap_or_else(|| AccountGasLimit::new())
    }

    pub fn get_account_gas_limit(&self) -> &AccountGasLimit {
        self.account_gas_limit.as_ref().unwrap_or_else(|| AccountGasLimit::default_instance())
    }

    fn get_account_gas_limit_for_reflect(&self) -> &::protobuf::SingularPtrField<AccountGasLimit> {
        &self.account_gas_limit
    }

    fn mut_account_gas_limit_for_reflect(&mut self) -> &mut ::protobuf::SingularPtrField<AccountGasLimit> {
        &mut self.account_gas_limit
    }

    // repeated bytes nodes = 5;
    ...
    fn descriptor_static(_: ::std::option::Option<RichStatus>) -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeUint64>(
                    "block_gas_limit",
                    RichStatus::get_block_gas_limit_for_reflect,
                    RichStatus::mut_block_gas_limit_for_reflect,
                ));
                fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<AccountGasLimit>>(
                    "account_gas_limit",
                    RichStatus::get_account_gas_limit_for_reflect,
                    RichStatus::mut_account_gas_limit_for_reflect,
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    value:\x028\x01\"\xb4\x01\n\nRichStatus\x12\x12\n\x04hash\x18\x01\x20\
    \x01(\x0cR\x04hash\x12\x16\n\x06height\x18\x02\x20\x01(\x04R\x06height\
    \x12&\n\x0fblock_gas_limit\x18\x03\x20\x01(\x04R\rblockGasLimit\x12<\n\
    \x11account_gas_limit\x18\x04\x20\x01(\x0b2\x10.AccountGasLimitR\x0facco\
    untGasLimit\x12\x14\n\x05nodes\x18\x05\x20\x03(\x0cR\x05nodes\"\x89\x01\
    \n\x0bTransaction\x12\x0e\n\x02to\x18\x01\x20\x01(\tR\x02to\x12\x14\n\
    \x05nonce\x18\x02\x20\x01(\tR\x05nonce\x12\x14\n\x05quota\x18\x03\x20\
    \x01(\x04R\x05quota\x12*\n\x11valid_until_block\x18\x04\x20\x01(\x04R\
    \x0fvalidUntilBlock\x12\x12\n\x04data\x18\x05\x20\x01(\x0cR\x04data\"\
    ...
    \x0b\n\x04\x04\x03\x02\0\x12\x03\x1f\x04\x20\n\r\n\x05\x04\x03\x02\0\x04\
    \x12\x04\x1f\x04\x1e\x19\n\x0c\n\x05\x04\x03\x02\0\x05\x12\x03\x1f\x04\n\
    \n\x0c\n\x05\x04\x03\x02\0\x01\x12\x03\x1f\x0b\x1b\n\x0c\n\x05\x04\x03\
    \x02\0\x03\x12\x03\x1f\x1e\x1f\n\x0b\n\x04\x04\x03\x02\x01\x12\x03\x20\
    \x04.\n\r\n\x05\x04\x03\x02\x01\x04\x12\x04\x20\x04\x1f\x20\n\x0c\n\x05\
    \x04\x03\x02\x01\x06\x12\x03\x20\x04\x16\n\x0c\n\x05\x04\x03\x02\x01\x01\
    ...
    \x03&\x04\x1f\n\r\n\x05\x04\x04\x02\x02\x04\x12\x04&\x04%\x16\n\x0c\n\
