...
_TRANSACTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='valid_until_block', full_name='Transaction.valid_until_block', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='data', full_name='Transaction.data', index=3,
