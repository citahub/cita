...
```js
params: [""]
...
```
####签名
1. 构造 Content -> content,设置合约代码的bytecode
2. 用 content 构造 Transaction -> transaction
3. 用 transaction 序列化 sha3 -> hash
4. 对 hash 进行签名 -> signature
5. 用 signature 和对应的签名算法 crypto 构造 SignedTransaction -> signed_transaction
6. signed_transaction 序列化 -> signed_content
7. signed_content 替换 transaction 的 content -> new_transaction
8. new_transaction 序列化作为 cita_sendTransaction 的 params
...
// contract bincode
let data = "".from_hex();
content.setdata(data);
let signed_transaction = SignedTransaction::new();

transaction.set_content(content.write_to_bytes());
let privkey = crypto::PrivKey::from(H256::from_str("a100df7a048e50ed308ea696dc600215098141cb391e9527329df289f9383f65").unwrap());
// sender: 5b073e9233944b5e729e46d618f0d8edf3d9c34a
let signature = sign(privkey, transaction.write_to_bytes().sha3()); 

signed_transaction.set_transaction(transaction.write_to_bytes());
signed_transaction.set_crypto(Crypto::SECP);
signed_transaction.set_signature(sign1.0.to_vec());

transaction.set_content(signed_transaction.set_transaction.write_to_bytes());
```

#### 签名后的交易

```

```
##### Returns
...
```js
// Request
curl -X POST --data '{"jsonrpc":"2.0","method":"cita_sendTransaction","params":[""],"id":1}'
...
// nonce = 0
// sender: "5b073e9233944b5e729e46d618f0d8edf3d9c34a"
// EOA address = "5b073e9233944b5e729e46d618f0d8edf3d9c34a"
