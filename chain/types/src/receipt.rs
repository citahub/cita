...
mod tests {
    ...
    fn test_no_state_root() {
        ...
        if HASH_NAME == "sha3"{
            ...
            expected = ::rustc_hex::FromHex::from_hex("").unwrap();
        }
        let r = Receipt::new(
            None,
            0x40cae.into(),
